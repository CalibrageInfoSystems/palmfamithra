...
public class GetIssueModel {
    ...
    public class ListResult {
        ...
        @SerializedName("labourRequests")
        @Expose
        private List<Object> labourRequests = null;
        ...
        public List<Object> getLabourRequests() {
            return labourRequests;
        }

        public void setLabourRequests(List<Object> labourRequests) {
            this.labourRequests = labourRequests;
        }
