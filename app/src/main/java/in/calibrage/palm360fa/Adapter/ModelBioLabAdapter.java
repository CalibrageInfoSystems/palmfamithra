...
public class ModelBioLabAdapter extends RecyclerView.Adapter<ModelBioLabAdapter.ViewHolder>{
    ...
    private ModelBioLabAdapter.listner listner;

    public ModelBioLabAdapter(List<ModelFert> list_products, Context context, ModelBioLabAdapter.listner listner) {
        super();
