...
import in.calibrage.palm360fa.Adapter.ModelBioLabAdapter;
...
public class BioLabProducts extends BaseActivity implements  ModelBioLabAdapter.listner{

    private RecyclerView recyclerView;
    private ModelBioLabAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bio_lab_products);
        ...
        Home_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(BioLabProducts.this, HomeActivity.class);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.bio_recycler_view);
        ...
        if (isOnline()){
            ...
            showDialog(BioLabProducts.this,getResources().getString(R.string.Internet));
            ...
            public void onClick(View view) {
                ...
                try {
                    if (myProductsList.size() > 0 & !TextUtils.isEmpty(mealTotalText.getText()) & mealTotalText.getText()!= "" ) {
                        ...
                        Intent i = new Intent(BioLabProducts.this, pole_godown_list.class);
                        ...
                        showDialog(BioLabProducts.this, getResources().getString(R.string.select_product_toast));
                    }
            ...
            public void onClick(View view) {
                ...
                try {
                    if (myProductsList.size() > 0 & !TextUtils.isEmpty(mealTotalText.getText()) & mealTotalText.getText()!= "" ) {
                        ...
                        Log.e("myProductsList===",myProductsList.toString());
                        Intent i = new Intent(BioLabProducts.this, bioproducts_list.class);
                        i.putExtra("Total_amount", mealTotalText.getText());
                        i.putExtra("godown_id",Godown_id);
                        i.putExtra("godown_code",Godown_code);
                        i.putExtra("godown_name",Godown_name);
...
//}
            ...
            adapter = new ModelBioLabAdapter(product_list, this, this);
