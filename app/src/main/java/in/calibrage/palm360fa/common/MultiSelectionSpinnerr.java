...
public class MultiSelectionSpinnerr extends Spinner implements OnMultiChoiceClickListener {
    ...
    public MultiSelectionSpinnerr(Context context) {
        super(context);
    ...
    public MultiSelectionSpinnerr(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean performClick() {
       if(_items != null && _items.length != 0 ) {
        ...
        builder.setTitle("Please Select District(s)");
